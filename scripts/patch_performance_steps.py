...
def patch_performance_steps(root: Path) -> None:
    ...
    source: str = "export { hbOperationColor, hbPerformancePage, drawHbPerformanceMode, hbPerformanceStep, releaseHbPerformanceStep, paintHbPerformance, resetHbPerformance, setHbPerformanceMode, syncHbPerformanceMode } from './hb-performance.js';\n" + path.read_text()
